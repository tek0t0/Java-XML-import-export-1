package softuni.xmlprocessing.controllers;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.boot.CommandLineRunner;
import org.springframework.stereotype.Component;
import softuni.xmlprocessing.services.*;
...
public class AppController implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        System.out.println("Select query from Car Dealer Ex ---> You don`t need to create output files in advance! The App will create them!");
